...
if(isset($_POST['submit2'])){
    ...
    $sql = "INSERT INTO login(a_level) SELECT $a_level from login WHERE username = '$username';";
//    $sql = "INSERT INTO login(a_level) values('".$a_level."') WHERE username = '$username';";
  if ( mysqli_query($db, $sql)){
    echo "*Admin has been added.*";
  }
  else {mysqli_query($db,$sql) or die(mysqli_error($db). "<br>".$sql);}
  $username1 = $_SESSION['USERNAME'];
  $s = "INSERT INTO activitytracker(username, activity) VALUES('$username1','Updated Admin Status of User');";
...
<main>
    ...
    <form class="rounded" method='POST'>
        ...
        <legend>Add Admin Status</legend>
